...
namespace MDToPPTX.PPTX.OpenXML
{
	class ImageSlideWriter
	{
		...
		public void AddImageContent(ShapeTree shapeTree1, uint ObjectID, PPTXImage Content)
		{
			...
			A.NonVisualDrawingPropertiesExtensionList nonVisualDrawingPropertiesExtensionList5 =
			...
			ApplicationNonVisualDrawingProperties applicationNonVisualDrawingProperties83 =
