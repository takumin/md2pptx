	...
	class TableSlideWriter
	{
		...
		private void AddTableCommonProperty(GraphicFrame graphicFrame1, uint ObjectID)
		{
			...
			OpenXmlUnknownElement openXmlUnknownElement1 = OpenXmlUnknownElement.CreateOpenXmlUnknownElement(
				"<a16:creationId xmlns:a16=\"http://schemas.microsoft.com/office/drawing/2014/main\" id=\"{7AB8EDC7-F9EF-4752-9A46-413B9437344B}\" />"
			);
			...
			NonVisualGraphicFrameDrawingProperties nonVisualGraphicFrameDrawingProperties1 =
			...
			ApplicationNonVisualDrawingPropertiesExtension applicationNonVisualDrawingPropertiesExtension1 =
				new ApplicationNonVisualDrawingPropertiesExtension() { Uri = "{D42A27DB-BD31-4B8C-83A1-F6EECF244321}" };
		...
		private A.TableRow CreateRow(
			List<PPTXTableColumn> Cols,
			PPTXTableRow Row,
			Dictionary<string, string> HyperLinkIDMap
		)
		{
