...
namespace MDToPPTX.PPTX
{
	...
	public class PPTXSetting
	{
		...
		public PPTXBlockSetting Header1 { get; set; } =
			new PPTXBlockSetting()
			{
				Font = new PPTXFont()
				{
					FontSize = 32,
					ForegroundColor = new PPTXColor(0, 0, 0),
					Bold = true,
					UnderLine = true,
					HAlign = EPPTXHAlign.Center,
				},
			};

		public PPTXBlockSetting Header2 { get; set; } =
			new PPTXBlockSetting()
			{
		...
		public PPTXBlockSetting Normal { get; set; } =
			new PPTXBlockSetting()
			{
		...
		public PPTXBlockSetting Code { get; set; } =
			new PPTXBlockSetting()
			{
		...
		public PPTXBlockSetting List { get; set; } =
			new PPTXBlockSetting()
			{
		...
		public PPTXBlockSetting QuoteBlock { get; set; } =
			new PPTXBlockSetting()
			{
				Font = new PPTXFont() { FontSize = 24, ForegroundColor = new PPTXColor(0, 0, 0) },
				Margin = new PPTXMargin(0.5f, 0.5f),
		...
		public PPTXBlockSetting Table { get; set; } =
			new PPTXBlockSetting()
			{
				Font = new PPTXFont() { FontSize = 22, ForegroundColor = new PPTXColor(0, 0, 0) },
				Margin = new PPTXMargin(0.5f, 0.5f, 0.5f),
		...
		public PPTXInlineSetting InlineCode { get; set; } =
			new PPTXInlineSetting()
			{
