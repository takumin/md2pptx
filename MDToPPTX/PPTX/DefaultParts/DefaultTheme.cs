...
namespace MDToPPTX.PPTX.DefaultParts
{
	internal class DefaultTheme
	{
		...
		{
			A.Theme theme1 = new A.Theme() { Name = "Office テーマ" };
			theme1.AddNamespaceDeclaration("a", "http://schemas.openxmlformats.org/drawingml/2006/main");

			A.ThemeElements themeElements1 = new A.ThemeElements();

			A.ColorScheme colorScheme1 = new A.ColorScheme() { Name = "Office テーマ" };
			...
			A.FontScheme fontScheme1 = new A.FontScheme() { Name = "Office テーマ" };
			...
			A.FormatScheme formatScheme1 = new A.FormatScheme() { Name = "Office テーマ" };
